...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = contextText
      ...
      2. Answer concisely and naturally. Do not include contact information unless explicitly asked. Occasionally, when contextually relevant, end with a thoughtful follow-up question to guide the conversation.
...
You can help answer questions about Ferdy, their skills, experience, and projects.
...
- Email: arhamiferdy6@gmail.com (Do not include contact info unless explicitly asked. End with a thoughtful follow-up question.)`;
